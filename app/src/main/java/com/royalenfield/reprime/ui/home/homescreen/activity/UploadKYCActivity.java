package com.royalenfield.reprime.ui.home.homescreen.activity;
...
import com.royalenfield.reprime.ui.home.homescreen.presenter.UploadKYCPresenter;
...
public class UploadKYCActivity extends REBaseActivity implements View.OnClickListener, UploadDocumentView, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private UploadKYCPresenter uploadDocPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
			...
			((TextView) findViewById(R.id.tvTitle)).setText(getResources().getString(R.string.kyc_document));
...
//            getSupportActionBar().setDisplayShowHomeEnabled(true);
        ...
        uploadDocPresenter = new UploadKYCPresenter(this, new UploadKYCInteractor());
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.upload_doc_submit:
                ...
                showLoading();
                Gson gson = new Gson();
                uploadDocPresenter.submitDocs(ownerShipUri, getIntent().getStringExtra("CHESIS"));
...
//                finish();
    ...
    private void onOwnerShipFile(Intent data) {
        try {
            ...
            if (mimeType == null) {
                ...
                String id = REAddVehicleUtils.KYC_DOCUMENT+getFileExt(filename);
    ...
    public void onOwnershipFileSizeError() {
        ...
        ownshipDocTxt.setText(getResources().getString(R.string.kyc_document));
