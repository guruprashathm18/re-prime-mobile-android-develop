package com.bosch.softtec.micro.tenzing.client;

import com.bosch.softtec.micro.tenzing.client.auth.ApiKeyAuth;
import com.bosch.softtec.micro.tenzing.client.auth.HttpBasicAuth;
import com.bosch.softtec.micro.tenzing.client.auth.HttpBearerAuth;
import com.bosch.softtec.micro.tenzing.client.auth.OAuth;
import com.bosch.softtec.micro.tenzing.client.auth.OAuth.AccessTokenListener;
import com.bosch.softtec.micro.tenzing.client.auth.OAuthFlow;
...
public class ApiClient {
  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      Interceptor auth;
      if ("Tenzing".equals(authName)) {

        auth = new OAuth(OAuthFlow.accessCode, "https://tenzing-demo.auth.eu-central-1.amazoncognito.com/oauth2/authorize", "https://tenzing-demo.auth.eu-central-1.amazoncognito.com/oauth2/token", "openid, trip/access, admin/access");
      } else {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "https://tenzing.prod.msmicro.ccf-services-001.de";
    if (!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
