...
public class Global
{
	...
	public static String mCompany = "Royal Enfield";
	public static String mEmail = "dnait@royalenfield.com";
	public static String mKey = "B8W9KR-QBFJBT-XA4XYF-X3WJY8-8C61KE-HLB6QV";
	...
	public static boolean bFakeSignature = false;		// if true, the signature doesn't require the p12/pfx certificate file. Only the image is set to the form field.
	...
	public static boolean Init(ContextWrapper act, int license_type, String company_name, String mail, String serial)
	{
		...
		//binding to app ID "com.radaee.reader", expire time: 2022/09/10
		//license_type = active(act, "8ABE22CCD8FFABCDAA323CE341437435030398E5EDBE968602CD531F4247D0F8131969A90E859A058BBEF59DD79526C8");
		//ms_init = (license_type > 0);
		switch(license_type)
		{
		case 1:
