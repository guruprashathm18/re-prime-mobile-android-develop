...
public class PDFMainAct extends Activity {
    ...
    private void initNatigate()
    {
        final RDGridView vGrid = m_lay_navigate.findViewById(R.id.vw_grid);
        final TextView tPath = m_lay_navigate.findViewById(R.id.txt_path);
        vGrid.RDSetListener(m_locker_set, new RDGridView.RDGridAdt.OnGridListener() {
            @Override
            ...
            @Override
            public void OnPathChanged(String path) { tPath.setText(path); }
        });
        vGrid.RDSetRoot("/mnt");
        ...
        imgv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { vGrid.RDGoUp(); }
        });
        imgv = m_lay_navigate.findViewById(R.id.btn_refresh);
        imgv.setColorFilter(Global.toolbar_icon_color);
        imgv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { vGrid.RDFresh(); }
        });
        ...
        bar_view.findViewById(R.id.btn_remove).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        vGrid.RDRemove(m_item_grid.getAdapterPosition());
    ...
    {
        final RDRecentView vRecent = m_lay_recent.findViewById(R.id.vw_recent);
        vRecent.OpenRecent(m_locker_set, new RDRecentView.OnRecentListener() {
            @Override
    ...
    {
        final RDFilesView vFiles = m_lay_files.findViewById(R.id.vw_files);
        vFiles.Update(m_locker_set, new RDFilesView.OnFilesListener() {
            @Override
        ...
        imgv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { vFiles.Update(); }
        });
    }
