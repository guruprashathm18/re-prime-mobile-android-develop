...
public class PDFViewAct extends Activity implements ILayoutView.PDFLayoutListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!Global.cacheEnabled)
            m_layout.findViewById(R.id.ll_progress).setVisibility(View.GONE);
        ...
        else
        {
            ...
            final String pdf_pswd = intent.getStringExtra("PDFPswd");
            final String pdf_http = intent.getStringExtra("PDFHttp");
